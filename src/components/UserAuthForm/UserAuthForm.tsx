...
export function UserAuthForm({ className, ...props }: UserAuthFormProps) {
  ...
  async function onSubmit(data: FormData) {
    ...
    if (!signInResult?.ok) {
      return toast.error('There was a problem logging in. Please try again.')
    }
  ...
  return (
    <div className={cs('grid gap-6', className)} {...props}>
        ...
        <div className='grid gap-2'>
          <div className='grid gap-1'>
            ...
            <input
              ...
              className='my-0 mb-2 block h-9 w-full rounded-md border border-slate-300 py-2 px-3 text-sm placeholder:text-slate-400 hover:border-slate-400 focus:border-neutral-300 focus:outline-none focus:ring-2 focus:ring-neutral-800 focus:ring-offset-1 text-slate-700'
              type='email'
              autoCapitalize='none'
              autoComplete='email'
              autoCorrect='off'
      ...
      <div className='w-full flex items-center'>
        <div className='flex-1 border-t border-bg-3' />

        <div className='flex-1 flex-shrink-0 whitespace-nowrap block px-2 text-xs uppercase text-fg-2'>
          Or continue with
        </div>
